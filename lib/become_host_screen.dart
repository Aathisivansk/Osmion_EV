...
class _BecomeHostScreenState extends State<BecomeHostScreen> {
  ...
  Future<void> _updateHostingStatus(bool newStatus) async {
    // Note: For this to work, your API and HostingSession object
    // need to handle updates. The current API creates a session.
    // A more robust solution would have a dedicated endpoint for updates.
    setState(() {
      _isHosting = newStatus;
      // You could trigger an API call here to update the status on the server
      print("Hosting status updated to: $_isHosting");
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Contact Details (e.g., Phone Number)',
                    border: OutlineInputBorder()),
