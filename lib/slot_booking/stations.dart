...
import 'package:osmion/slot_booking/booking_confirmation_page.dart'; // Correct import for BookingConfirmationPage
...
class StationDetailsPage extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            // The "Book Now" button navigates to the next page
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                // Only enable the button if the charger is available
                onPressed: charger.isAvailable ? () {
                  // Navigate to the new booking confirmation page
                  Navigator.push(
                    context,
                    MaterialPageRoute(
  ...
  BookingConfirmationPage({required StationDetails station, required Charger charger}) {}
}
